                    ...
                    <form id="insertForm" method="post" action="project_add.php">
                        ...
                        <div class="row mb-2">
                            <div class="col">
                                ...
                                <input type="date" class="form-control" name="start_date" id="start" min="<?= $current_date; ?>" required/>
                            </div>
                            <div class="col">
                                <label for="end">End</label>
                                <input type="date" class="form-control" name="end_date" id="end" min="<?= $current_date; ?>" required/>
                            </div>
                        </div>
